...
class AETD3Agent:
    def __init__(self, base_dim: int, depth_shape, action_space, args, device=None, seed=None):
        ...
        # State dim = base_feature_dim + encoder.repr_dim
        ...
        # Optimizers
        # Combine Actor + Actor Encoder + Actor Base Adapter parameters
        ...
        # Combine Critic + Critic Encoder + Critic Base Adapter parameters
    ...
    def train(self, progress_ratio=0.0):
        ...
        with torch.no_grad():
            ...
            for _ in range(self.adaptive_k):
                ...
                q1, q2 = self.critic_target(next_states_critic, noisy_action)
        ...
        # Optimize Critic (and Critic Encoder + Critic Base Adapter + MetaNet)
