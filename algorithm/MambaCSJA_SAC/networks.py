...
from ..MambaCSJA import MambaAttentionCNN

class Encoder(MambaAttentionCNN):
    """
    Encoder that uses Mamba-CSJA attention for stacked depth frames.
    """
    def __init__(self, input_height, input_width, input_channels=4):
        # We enforce output_dim=64 and use attention stage (conv2 or conv3 depending on the implementation)
        super().__init__(
