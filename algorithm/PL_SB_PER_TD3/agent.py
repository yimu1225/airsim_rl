...
class PLSB_PERTD3Agent:
    def __init__(self, base_dim: int, depth_shape, action_space, args, device=None, seed=None):
        ...
        self.mu_mid = float(get_algo_param(args, "sb_per_td3_mu_mid", 0.45))
        self.mu_high = float(get_algo_param(args, "sb_per_td3_mu_high", 0.60))
        self.mu_step1 = float(get_algo_param(args, "sb_per_td3_mu_step1", 0.25))
        self.mu_step2 = float(get_algo_param(args, "sb_per_td3_mu_step2", 0.65))
