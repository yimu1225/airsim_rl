...
class SB_PERMambaCSJASACAgent:
    """Soft Actor-Critic (SAC) Agent with Mamba-CSJA attention and Dual Prioritized Experience Replay (SB_PER).
    ...
    - Dual prioritized replay pools (success / regular) with dynamic mixing
    """
