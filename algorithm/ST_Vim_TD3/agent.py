...
class STVimTD3Agent:
    ...
    def train(self, progress_ratio: float = 0.0):
        ...
        nn.utils.clip_grad_norm_(list(self.critic_encoder.parameters()) + list(self.critic_base_net.parameters()) + list(self.critic_1.parameters()) + list(self.critic_2.parameters()), self.grad_clip)
