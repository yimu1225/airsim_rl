...
class VimTD3Agent:
    def __init__(self, base_dim, depth_shape, action_space, args, device=None, seed=None):
        ...
        self.actor_encoder = VimEncoder(self.args).to(self.device)
        ...
        self.critic_encoder = VimEncoder(self.args).to(self.device)
