...
from .networks import Actor, Critic, VisualEncoder, GRUEncoder, MetaNet, BaseStateExpander
from .buffer import SequenceReplayBuffer


class GRUAETD3Agent:
    """
    AETD3 with GRU for POMDP.
    ...
    def __init__(self, base_dim, depth_shape, action_space, args, device=None):
        ...
        print(f"AETD3-GRU Agent using device: {self.device}")
        ...
        self.critic_gru = GRUEncoder(expanded_base_dim=expanded_base_dim, visual_feature_dim=feature_dim, hidden_dim=self.gru_hidden_dim, num_layers=gru_layers).to(self.device)
        self.critic_gru_target = GRUEncoder(expanded_base_dim=expanded_base_dim, visual_feature_dim=feature_dim, hidden_dim=self.gru_hidden_dim, num_layers=gru_layers).to(self.device)
        ...
        self.actor_gru = GRUEncoder(expanded_base_dim=expanded_base_dim, visual_feature_dim=feature_dim, hidden_dim=self.gru_hidden_dim, num_layers=gru_layers).to(self.device)
        self.actor_gru_target = GRUEncoder(expanded_base_dim=expanded_base_dim, visual_feature_dim=feature_dim, hidden_dim=self.gru_hidden_dim, num_layers=gru_layers).to(self.device)
