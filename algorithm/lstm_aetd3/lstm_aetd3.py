...
from .networks import Actor, Critic, VisualEncoder, LSTMEncoder, MetaNet, BaseStateExpander
...
class LSTMAETD3Agent:
    ...
    def __init__(self, base_dim, depth_shape, action_space, args, device=None):
        ...
        # Base State Expanders (separate for actor/critic, like visual encoders)
