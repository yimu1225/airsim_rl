...
class VMambaTD3NoCrossAgent:
    ...
    def train(self, progress_ratio=0.0):
        ...
        if depth.dim() == 5:
            ...
            raise RuntimeError(f"Unexpected depth tensor shape in vmamba_td3_no_cross.train: {tuple(depth.shape)}")
    ...
    def load(self, filename):
        ...
        if 'actor_visual_encoder' in checkpoint:
            ...
            print("Legacy checkpoint loading not fully supported for VMambaTD3NoCross...")
            # Implement if needed
